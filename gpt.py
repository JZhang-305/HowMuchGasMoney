...
st.write("The best gas price calculator for extorting your cheap friends! Or you can use this to calculate gas from A to B with no pickups but what's the fun in that!")
st.write("Example Address Format: 4 Pennsylvania Plaza, New York, NY 10001")
...
if len(origin) != 0 and len(destination) != 0 and len(str(mpg)) != 0 and len(str(cost_of_gas)) != 0 and st.button('Calculate ⛽'):
    ...
    if results:
        ...
        st.write("your inputs are wacky, no route could be found")
